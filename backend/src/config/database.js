...
export async function initDatabase() {
  ...
  db.run(`
    CREATE TABLE IF NOT EXISTS tavus_script_jobs (
      id INTEGER PRIMARY KEY AUTOINCREMENT,
      status TEXT NOT NULL DEFAULT 'pending',
      script_text TEXT NOT NULL,
      provider_name TEXT DEFAULT 'tavus',
  ...
  `);
  db.run(`CREATE INDEX IF NOT EXISTS idx_tavus_script_jobs_status ON tavus_script_jobs(status, created_at)`);
